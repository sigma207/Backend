...
public class Password {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("1234与密码相同？"+Password.authenticatePassword(password, inputstr));
        inputstr = "123456";
        System.out.println("123456与密码相同？"+Password.authenticatePassword(password, inputstr));

        String pp = Password.createPassword("AFALL");
        System.out.println("对AFALL用MD5加密后："+pp);
    }
}